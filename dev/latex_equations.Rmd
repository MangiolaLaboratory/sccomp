...
& \psi_{g,d} \sim \text{Normal} \left(\lambda_{0} + \lambda_{1} \bar{\mu_{g,d}}, \phi \right ) & \textrm{ (17) } \\
& \hat{\omega_{d}} = \omega_{d} - \left( \gamma_{d} \lambda_{1} \right)  \textrm{ for } D > 2, or = \omega_{d} \textrm{ otherwise } & \textrm{ (18) } \\
