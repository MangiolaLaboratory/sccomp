...
& \boldsymbol{M}_{G,S} = \boldsymbol{\Gamma}_{G,C} \times \boldsymbol{X}_{C,S} \textrm{ for } s \in[1..S] \sum_{g=1}^{G} \mu_{g, s} = 0 & \textrm{ (13) } \\
...
& P\left (\boldsymbol{\Gamma}, \lambda_{0}, \lambda, \phi \right )  \prod_{g=1}^{G} P\left ( \omega_{g} | \mu_{g,1}, \lambda_{0}, \lambda_{1}, \phi \right ) \prod_{s=1}^{S} \prod_{g=1}^{G} P\left ( k_{g,s} | n_{s}, \mu_{g}, X_{s}, \omega_{g} \right ) & \textrm{ (14) } \\

& k_{g,s} \sim \text{BetaBinomial} \left(n_{s}, \text{InverseMultinomialLogistic}(\boldsymbol{\mu_{s}})_{g}, e^{\omega}_{g} \right ) & \textrm{ (15) } \\

& \omega_{g} \sim \text{Normal} \left(\lambda_{0} + \lambda_{1} \gamma_{g,1}, \phi \right ) & \textrm{ (16) } \\
& \gamma_{g,c} \sim \text{Normal} \left(0,5 \right ) & \textrm{ (17) } \\
& \lambda_{0}, \lambda_{1}, \phi \sim \text{Normal} \left(0,5 \right ) & \textrm{ (18) } \\

& \text{E}\left(\omega_{g,i} \right) = \lambda_{0} + \lambda_{1} \gamma_{g,i} & \textrm{ (19) } \\
...
& \text{var(k)} \approx  n \left(\frac{\alpha}{\alpha + \beta} \right) + \lambda_{2} \left(\frac{(\frac{\alpha}{\alpha + \beta})}{GM(\frac{\alpha}{\alpha + \beta})}\right)^{\lambda_1} n^{\lambda_1 + 1} \left(n(\frac{\alpha}{\alpha + \beta}) \right)^{1-\lambda_{1}} \\

& \text{var(k)} \approx  n \left(\frac{\alpha}{\alpha + \beta} \right) + \lambda_{2} \left(\frac{(\frac{\alpha}{\alpha + \beta})}{log(\frac{\alpha}{\alpha + \beta})}\right)^{\lambda_1} n^{\lambda_1 + 1} \left(n(\frac{\alpha}{\alpha + \beta}) \right)^{1-\lambda_{1}} \\
