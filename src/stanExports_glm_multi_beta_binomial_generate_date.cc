...
#include "stanExports_glm_multi_beta_binomial_generate_date.h"

RCPP_MODULE(stan_fit4glm_multi_beta_binomial_generate_date_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_glm_multi_beta_binomial_generate_date")
