...
data_spread_to_model_input =
  function(
    ...
    .count = enquo(.count)
    .grouping_for_random_intercept = random_intercept_elements |> map(~ .x$grouping) |> unlist()
    ...
    if(N_random_intercepts > 0){
      ...
      X_random_intercept = matrix(rep(1, nrow(.data_spread)))
    }
