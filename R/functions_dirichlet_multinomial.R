...
dirichlet_multinomial_glm = function(.data,
                                     ...
                                     .cell_type,
                                     .count,
                                     prior_mean_overdispersion_association = NULL,
